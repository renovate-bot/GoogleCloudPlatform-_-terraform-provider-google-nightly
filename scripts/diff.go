...
import (
	...
	googleOld "github.com/hashicorp/terraform-provider-clean-google-nightly/google-nightly/provider"
	// "github.com/hashicorp/terraform-provider-google-nightly/google-nightly/provider" will be replaced with corresponding package based on the version when generating the provider package
	google "github.com/hashicorp/terraform-provider-google-nightly/google-nightly/provider"
)
