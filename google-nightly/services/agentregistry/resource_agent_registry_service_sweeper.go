...
func listAndActionAgentRegistryService(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://agentregistry.googleapis.com/v1alpha/projects/{{project}}/locations/{{location}}/services", "?")[0]
...
func deleteResourceAgentRegistryService(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://agentregistry.googleapis.com/v1alpha/projects/{{project}}/locations/{{location}}/services/{{service_id}}"
