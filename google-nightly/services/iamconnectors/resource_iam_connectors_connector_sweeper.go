...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionIamConnectorsConnector,
		DeleteFunction: testSweepIamConnectorsConnector,
	}
...
func testSweepIamConnectorsConnector(_ string) error {
	return listAndActionIamConnectorsConnector(deleteResourceIamConnectorsConnector)
}

func listAndActionIamConnectorsConnector(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "IamConnectorsConnector"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://iamconnectors.googleapis.com/v1alpha/projects/{{project}}/locations/{{location}}/connectors", "?")[0]
...
func deleteResourceIamConnectorsConnector(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://iamconnectors.googleapis.com/v1alpha/projects/{{project}}/locations/{{location}}/connectors/{{connector_id}}"
